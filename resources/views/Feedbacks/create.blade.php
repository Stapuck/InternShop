        ...
        <div class="flex justify-center items-center h-90">
            <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
                ...
                <section class="pt-2 pb-4">
                    <h1 class="text-xl font-extrabold uppercase flex justify-center">Votre avis compte !</h1>
                </section>

                <section>
                    <form class="flex flex-col" method="POST" action="{{ route('Feedbacks.store') }}">
                        @csrf
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="feedback">Laissez
                                votre avis (max:500 mots)</label>
                            <textarea name="opinion" id="t1" maxlength="500"
