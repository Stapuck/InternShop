        ...
        <div class="flex justify-center items-center">
            <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
                ...
                <section class="pt-2 pb-4">
                    <h1 class="text-xl font-extrabold uppercase flex justify-center">Création d'une offre</h1>
                </section>

                <section>
                    <form class="flex flex-col" method="POST" action="{{ route('Offers.store') }}">
                        @csrf
                        <!-- name -->
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            ...
                            <textarea name="detail" id="t1" maxlength="1500"
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="duration">Durée (
                                /semaines)</label>
                            <input type="text" name="duration" autofocus required
                        ...
                        <div class="pt-2 mb-6 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="skill">Compétences</label>
                            {{-- <div class="flex justify-center items-centers"> --}}
                            <select name="skill" id="skill"
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                            <option value="">Sélectionnez un skill</option>
                            @foreach ($OffersList as $offer)
                                <option value="{{ $offer->skill }}">{{ $offer->skill }}</option>
                            @endforeach
                            </select>
                        </div>
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            ...
                            <input type="number" pattern="[0-10000]+" name="gratification" autofocus required
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                        </div>
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="name">Nom de l'entreprise</label>

                            <select name="companies_id" id="company"
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                            ...
                            {{-- <button type="button"
                                class="m-3 bg-Accent rounded-lg w-[30px] h-[30px] hover:drop-shadow transform hover:scale-105 duration-300 ease-in-out ml-3 p-1">
                                <a href="/Companies/create"></a>
                            </button> --}}
