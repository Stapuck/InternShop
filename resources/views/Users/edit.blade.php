    ...
    <div class="flex justify-center items-center ">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Modifier un utilisateur</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST" action="{{ route('Users.update', $requestItem->id) }}">
                    @csrf
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="text" name="first_name" autofocus required value={{ $requestItem->first_name }}
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="text" name="last_name" autofocus required value={{ $requestItem->last_name }}
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="mail" name="email" autofocus required value={{ $requestItem->email }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div>

                    <!-- password -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="password">Mot de
                            passe</label>
                        <input type="text" name="password" autofocus required value={{ $requestItem->password }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div>

                    <!-- Date de naissance -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="birth_date">Date
                            de
                            naissance</label>
                        <input type="date" name="birth_date" autofocus required value={{ $requestItem->birth_date }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div>
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="phone_number">Téléphone</label>
                        <input type="tel" name="phone_number" autofocus required
                            value={{ $requestItem->phone_number }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div>
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="promotions_id">Promotions</label>
