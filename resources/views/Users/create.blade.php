        ...
        <div class="flex justify-center items-center m-8">
            <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
                ...
                <section class="pt-2 pb-4">
                    <h1 class="text-xl font-extrabold uppercase flex justify-center">Créer un utilisateur</h1>
                </section>
                ...
                <section>
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="first_name"
                                name="first_name">Prénoms</label>
                            <input
                                ...
                                id="first_name" type="text" name="first_name" required autofocus
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="last_name"
                                value="last_name">Nom</label>
                            <input
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]"
                                id="last_name" type="text" name="last_name" required autofocus
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="phone_number"
                                value="phone_number">Téléphone</label>
                            <input
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]"
                                id="phone_number" type="text" name="phone_number" required autofocus
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="birth_date"
                                value="birth_date">Date de naissance</label>
                            <input
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]"
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="email"
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="password"
                                value="password">Mot de passe</label>
                            <input
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]"
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="password_confirmation" value="password_confirmation"> Confirmer le mot de
                                passe</label>
                            <input
                                class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]"
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="roles">Rôles</label>
                            <input type="radio" name="roles_id" value="4"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            Entreprise
                            <input type="radio" name="roles_id" value="2"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            Etudiant
                            <input type="radio" name="roles_id" value="3"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            Pilote
                            <input type="radio" name="roles_id" value="1"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            Admin
                        </div>
                        ...
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="promotions">Promotions</label>
                            <input type="radio" name="promotions_id" value="1"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            A1
                            <input type="radio" name="promotions_id" value="2"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            A2
                            <input type="radio" name="promotions_id" value="3"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            A3
                            <input type="radio" name="promotions_id" value="4"
                                class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                            A4
                            <input type="radio" name="promotions_id" value="5"
                                class="m-1 text-sm text-gray-600 accent-[#4A7B59]">
                            A5
                        </div>

                        <button type="submit"
                            class="p-4 mb-2 text-sm font-bold text-white uppercase w-full transition duration-300 bg-[#4A7B59] rounded-sm shadow-sm hover:bg-[#649673] hover:shadow-md">
                            Créer
