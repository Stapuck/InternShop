...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <header class="header mb-4">
        <nav class="navbar">
            ...
            <div class="mr-96 flex">
                <form method="POST" action="{{ route('Users.search') }}" class=" ml-20 flex">
                    @csrf
    ...
    <div class="list-offers">
        ...
        @if (Auth::check() && Auth::user()->roles_id === 1 ||Auth::check() && Auth::user()->roles_id === 3)
...
{{-- <div class="px-4 text-xs">
        <button type="button"
            class="p-2 mb-4 mr-2 text-xs font-medium text-white transition duration-300 bg-[#4A7B59] rounded-sm shadow-sm hover:bg-[#649673] hover:shadow-md"
            onclick="window.location='{{ route('Users.create', $item->id) }}'"> Créer un utilisateur
        </button>
    </div>
</div> --}}
