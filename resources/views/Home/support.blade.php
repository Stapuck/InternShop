    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            <div class="w-full md:w-1/2">
                ...
                <p class="text-gray-700 leading-7 text-justify">Consultez notre foire aux questions pour trouver des
                    réponses à vos
                    questions les plus courantes. Si vous ne trouvez pas ce que vous cherchez, n'hésitez pas à nous
                    contacter.</p>
                <a href="/FAQ"
                    class="inline-block mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Voir
                    la FAQ</a>
            </div>

            <div class="w-full md:w-1/2 ml-4">
                <h2 class="text-2xl font-bold mb-4">Nous contacter</h2>
                <p class="text-gray-700 leading-7 text-justify">Si vous avez besoin d'aide pour utiliser notre
                    plateforme, ou si vous
                    avez des questions sur nos services, n'hésitez pas à nous contacter. Notre équipe de support est
                    disponible pour vous aider.</p>
                <a href="/Contact"
                    class="inline-block mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Nous
                    contacter</a>
            </div>
        </div>

        <div class="mt-8">
            <h2 class="text-2xl font-bold mb-4">Centre d'aide</h2>
            <p class="text-gray-700 leading-7 text-justify">Notre centre d'aide regroupe des guides et des tutoriels
                pour vous aider
                à utiliser notre plateforme et pour répondre à vos questions les plus fréquentes. Consultez-le pour
                trouver des réponses à vos questions.</p>
            <a href="#"
                class="inline-block mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Accéder
                au centre d'aide</a>
        </div>
