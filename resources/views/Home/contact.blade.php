...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <div class="container mx-auto pt-2 items-center mb-2">
        <h1 class="text-3xl font-medium text-[#4A7B59] mb-4 pl-2">Un problème ? Contactez-nous.</h1>

        <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-1/2 px-4 mb-4 md:mb-0">
                <h2 class="text-2xl font-bold mb-4">Formulaire de contact</h2>
            ...
            <div class="w-full md:w-1/2 px-4 py-24">
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex items-center justify-center">
                    <div class="">
                        <h2 class="text-2xl font-bold mb-4">Informations de contact</h2>
                        <p class="text-gray-700 leading-7">Vous pouvez également nous contacter par téléphone ou par
                            email.
                        </p>
                        <ul class="mt-4">
                            <li class="mb-2"><span class="font-bold">Téléphone:</span> +33 1 23 45 67 89</li>
                            <li class="mb-2"><span class="font-bold">Email:</span> info@internshop.com</li>
                            <li class="mb-2"><span class="font-bold">Adresse:</span> 123 rue de la Paix, 75008 Paris,
                                France</li>
                        </ul>
                    </div>
                </div>
