...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-medium text-gray-800 mb-8">Découvez nos derniers articles</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div class="px-4 py-4">
                    ...
                    <p class="text-gray-700 text-base mb-4">Votre stage peut vous permettre de vous démarquer auprès
                        des
