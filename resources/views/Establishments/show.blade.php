    ...
    <div class="flex flex-col items-center m-20 ">
        <div class="mx-6 py-12 w-96 bg-white rounded-lg shadow-lg ">
            <div class="px-6">
                ...
                <div class="flex">
                    ...
                    <p class="text-black ml-2">
                        {{ $EstablishmentsList->phone_number }}
                    </p>
                </div>
                ...
                <div class="flex">
                    ...
                    <p class="text-black ml-2">
                        {{ $EstablishmentsList->localisations_id }}
                        {{ $EstablishmentsList->Localisations->street_number }}
                        {{ $EstablishmentsList->Localisations->street_name }}
                        {{ $EstablishmentsList->Localisations->town }}
                        {{ $EstablishmentsList->Localisations->zip_code }}
                    </p>
                </div>
        ...
        <div class="flex">
            <div class="mx-6 flex-1">
                <form action="{{ route('Establishments.index', $EstablishmentsList->id) }}" method="GET">
                    <button type="submit"
            ...
            @if (Auth::check() && Auth::user()->roles_id === 1)
                <div class="mx-6 flex-1">
                    <form action="{{ route('Establishments.edit', $EstablishmentsList->id) }}" method="GET">
                        <button type="submit"
                ...
                {{-- Bouton Supprimer --}}
                <div class="mx-6 flex-1">
                    <form action="{{ route('Establishments.destroy', $EstablishmentsList->id) }}" method="POST">
                        @csrf
                        @method('delete')
                        <button type="submit"
