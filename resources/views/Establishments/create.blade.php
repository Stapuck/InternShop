...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <body class="min-h-screen  antialiased bg-gray-100" style="font-family: 'Poppins';">
        <div class="flex justify-center items-center h-90 ">
            <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">

                <!-- titre du formulaire -->
                <section class="pt-2 pb-4">
                    <h1 class="text-xl font-extrabold uppercase flex justify-center">Création d'un établissement</h1>
                </section>

                <section>
                    <form class="flex flex-col" method="POST" action="{{ route('Establishments.store') }}">
                        @csrf
                        ...
                        <input type="text" pattern="[1-5000]+" name="street_number" autofocus required
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div> --}}
