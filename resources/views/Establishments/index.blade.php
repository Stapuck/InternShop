    ...
    <body>
        <div class="list-establishments">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mx-6">
                @foreach ($EstablishmentsList as $item)
                    <div
                        ...
                        <div class="flex">
                            ...
                            <p class="text-black ml-2">
                                {{ $item->localisations_id }}
                                {{ $item->Localisations->street_number }}
                                {{ $item->Localisations->street_name }}
                                {{ $item->Localisations->town }}
                                {{ $item->Localisations->zip_code }}
                            </p>
                        </div>

                        <p
                            class="px-6 py-4 whitespace-no-wrap text-center border-b border-gray-300 text-sm leading-5 font-medium">
                            <a href="{{ route('Establishments.show', $item->id) }}"
            ...
            <div class="px-4 text-xs">
                <form action="{{ route('Establishments.create') }}" method="GET">
                    <button type="submit"
