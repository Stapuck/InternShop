...
<head>
    ...
    <title>Establishments show</title>
    ...
    <div class="flex justify-center items-center h-auto">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Modifier d'un établissement</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST"
                    action="{{ route('Establishments.update', $requestItem->id) }}">
                    @csrf

                    <!-- establishement_name -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="name">Nom
                            établissement</label>
                        <input type="text" name="name" autofocus required value={{ $requestItem->name }}
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="localisations_id">Id
                            Localisation</label>
                        <input type="number" min="0" name="localisations_id" autofocus required
                            value={{ $requestItem->localisations_id }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div>
                    ...
                    {{-- <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="text"  name="street_number" autofocus required value={{$requestItem->street_number}}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div> --}}
                    ...
                    {{-- <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="text" name="town" autofocus required
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div> --}}
                    ...
                    {{-- <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="text" name="region" autofocus required
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div> --}}
