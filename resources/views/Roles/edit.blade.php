...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <body class="min-h-screen antialiased bg-gray-100" style="font-family: 'Poppins';">
        <div class="flex justify-center items-center h-screen">
            <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
                ...
                <section class="pt-2 pb-4">
                    <h1 class="text-xl font-extrabold uppercase flex justify-center">Roles</h1>
                </section>

                <section>
                    <form class="flex flex-col" method="POST" action="{{ route('Roles.update', $requestItem->id) }}">
                        @csrf

                        <!-- Roles -->
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                                for="title">Roles</label>
                            <input type="text" name="title" autofocus required value={{ $requestItem->title }}
                        ...
                        <button type="submit"
                            class="w-full p-4 mb-2 text-sm font-bold text-white uppercase transition duration-300 bg-[#4A7B59] rounded-sm shadow-sm hover:bg-[#649673] hover:shadow-md">
                            Mettre à jour
        ...
        class=" m-2 text-sm font-semibold text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline">Retour</a><br>
