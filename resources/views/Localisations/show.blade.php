...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            ...
                            Code postal</th>
                        <th
                            class="px-6 py-3  border-r border-t border-b border-gray-300 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider">
    ...
    {{-- <form action="{{ route('Feedbacks.destroy', $item->id) }}" method="POST">
        @csrf
        @method('delete')
        <button type="submit">Supprimer la candidature</button>
    </form> --}}

    {{-- <a href="{{ route('Feedbacks.edit', $item->id) }}">Éditer la candidature<br></a> --}}
