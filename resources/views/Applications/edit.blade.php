    ...
    <div class="flex justify-center items-center h-screen">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Éditer une candidature</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST"
                    action="{{ route('Applications.update', $requestItem->id) }}">
                    @csrf
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="file" name="synopsis" id="cv" required value={{ $requestItem->synopsis }}
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="file" name="application_letter" id="application_letter" required
                            value={{ $requestItem->application_letter }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div>
                    ...
                    <!-- Ref offre -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="offer_id">
                            reference de l'offre</label>
                        <input type="number" min="0" name="offers_id" autofocus required
                            value={{ $requestItem->offers_id }}
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="radio" name="steps" value="1"
                            class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                        Envoyer
                        <input type="radio" name="steps" value="2"
                            class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                        Entretien
                        <input type="radio" name="steps" value="3"
                            class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                        Réponse
                    </div>
