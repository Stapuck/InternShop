    ...
    <div class="flex justify-center items-center h-screen">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Candidature</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST" action="{{ route('Applications.store') }}">
                    @csrf

                    <!-- fileUpload -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="fileUpload">CV</label>
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="fileUpload">Lettre
                            de motivation</label>
                        <input type="file" name="application_letter" id="application_letter" required
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div>
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="offer">Référence de l'offre</label>
                        <input type="number" name="offers_id" id="Offers_id" autofocus required min="0"
                    ...
                    <div class="pt-2 mb-4 ">
                        ...
                        <input type="number" min="0" name="users_id" autofocus required value={{Auth::user()->id}} hidden
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div>
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="skill">Utilisateur</label>
                        <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                            <select name="skill" id="skill" class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]">
                    ...
                    {{-- <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="users_id">Id
                            Utilisateur</label>
                        <input type="number" min="0" name="users_id" autofocus required 
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div> --}}
                    @endif
                    ...
                    {{-- <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="promotions">Étapes</label>
                        <input type="radio" name="advancements_id" value="1"
                            class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                        Envoyer
                        <input type="radio" name="advancements_id" value="2"
                            class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                        Entretien
                        <input type="radio" name="advancements_id" value="3"
                            class="m-1 text-xs text-gray-600 accent-[#4A7B59]">
                        Réponse
                    </div> --}}

                    <div class="">
                        <input type="number" min="0" name="advancements_id" hidden required value="1"
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div>
