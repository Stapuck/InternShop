    ...
    <div class="flex justify-center items-center m-8">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Statut d'advancement</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST" action="{{ route('Advancements.store') }}">
                    @csrf
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        ...
                        <input type="text" name="steps" autofocus required
