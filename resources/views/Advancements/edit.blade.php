...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <div class="flex justify-center items-center m-10">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Éditer une évolution</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST"
                    action="{{ route('Advancements.update', $requestItem->id) }}">
                    @csrf

                    <!-- steps -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="steps">Étapes</label>
                        <input type="text" name="steps" required autofocus value={{ $requestItem->steps }}
    ...
    <a href="{{ url()->previous() }}" class="m-2 text-sm font-semibold text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline">Retour</a>
