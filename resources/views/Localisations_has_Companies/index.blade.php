...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <div class="list-Localisations m-12 mt-4">
        <table class="table-auto w-full ">
            ...
            <thead>
                <tr>
                    ...
                    <th
                        class="px-6 py-3 border-l border-t  border-b border-gray-300 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider">
                    ...
                    <th
                        ...
                        companies_id</th>
                    <th
                        class="px-6 py-3  border-t border-r  border-b border-gray-300 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider">
            ...
            <tbody>
                @foreach ($Localisations_has_CompaniesList as $item)
    ...
    {{-- <a href="{{ route('LocalisationsHasCompanies.index') }}"
