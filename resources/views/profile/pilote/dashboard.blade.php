...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    <main>
        ...
        {{-- mettre toutes les data sur cette page ne pas mettre d'autre page  --}}
        <div>
            <p class="text-2xl ml-4">Mes Informations personnelles</p><br>

            <div class="flex">
                <p class="mb-4 text-base text-black font-semibold ml-4 ">
                    Nom:
                </p>
                <p class="ml-1">
            ...
            @if (Auth::user()->promotion_id != 0)
                <div class="flex">
                    <p class="mb-4 text-base text-black font-semibold ml-4">Ma classe</p>
                    {{ Auth::user()->promotion_id }}
                    {{ Auth::user()->Promotion->name }}
                </div>
            @endif

            {{-- @if (Auth::user()->promotion_id === user()->promotion_id)
                <div class="flex">
                    <p class="mb-4 text-base text-black font-semibold ml-4">Mon pilote</p>
                    {{ Auth::user()->name }}
                </div>
            @endif --}}


            <a href="/Users">Acces Utilisateur</a>
