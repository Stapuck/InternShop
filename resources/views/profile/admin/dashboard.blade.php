...
<body class="antialiased bg-gray-100" style="font-family: 'Poppins';">
    ...
    {{-- <main class="my-12"> --}}
    <div class="text-3xl">
        <p class="font-bold text-center text-[#4A7B59]">Retrouver ici tous les éléments modifiables si besoin </p>
    </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mx-6">
            <div class="">
                <a href={{ route('Users.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/use.png') }}" alt="User">
                        <p class=" card-text text-xl flex justify-center pt-3">Utilisateurs</p>
                    </div>
                </a>
            </div>
            ...
            <div class="">
                <a href={{ route('Companies.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/company.png') }}" alt="Company">
            ...
            <div class="">
                <a href={{ route('Establishments.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/school.png') }}" alt="Establishement">
                        <p class=" card-text text-xl flex justify-center pt-3">Ecoles</p>
                    </div>
                </a>
            </div>
            ...
            <div class="">
                <a href={{ route('Offers.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/job.png') }}" alt="Offer">
                        <p class=" card-text text-xl flex justify-center pt-3">Offres</p>
                    </div>
                </a>
            </div>
            ...
            <div class="">
                <a href={{ route('Feedbacks.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/feed.png') }}" alt="Feedback">
                        <p class=" card-text text-xl flex justify-center pt-3">Avis</p>
                    </div>
                </a>
            </div>
            ...
            <div class="">
                <a href={{ route('Roles.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/role.png') }}" alt="Role">
                        <p class=" card-text text-xl flex justify-center pt-3">Rôles</p>
                    </div>
                </a>
            </div>
            ...
            <div class="">
                <a href={{ route('Localisations.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/loc.png') }}" alt="Localisations">
                        <p class=" card-text text-xl flex justify-center pt-3">Localisations</p>
                    </div>
                </a>
            </div>
            ...
            <div class="">
                <a href={{ route('Applications.index') }}>
                    <div class="p-5 pb-10 flex flex-col pt-10 px-3 transition duration-300 ease-out hover:scale-105">
                        <img class=" drop-shadow-xl card-body rounded object-cover w-96 h-60"
                            src="{{ asset('imgs/candit.png') }}" alt="Candidature">
                        <p class=" card-text text-xl flex justify-center pt-3">Candidature</p>
                    </div>
                </a>
            </div>
