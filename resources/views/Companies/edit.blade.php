    ...
    <div class="flex justify-center items-center m-4 ">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Modifier une entreprise</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST" action="{{ route('Companies.update', $requestItem->id) }}">
                    @csrf
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="student_from_cesi">Elèves du CESI</label>
                        <input type="number" min="0" name="students_from_cesi" autofocus required
                            value={{ $requestItem->students_from_cesi }}
                    ...
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="business_line">Domaine d'activité</label>
                        <input type="text" name="business_line" autofocus required
                            value={{ $requestItem->business_line }}
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]" />
                    </div>
