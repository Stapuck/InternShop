        ...
        <div class="flex flex-col items-center m-20 ">
            <div class="mx-6 py-12 w-96 bg-white rounded-lg shadow-lg ">
                <div class="px-6">
                    ...
                    <div class="flex flex-col">
                        <div>
                            <h2 class="text-center">Liste des offres associées : </h2>
                        </div>
                        <div class="flex flex-col">
                            @foreach ($offers as $item)
                                @if ($item->companies_id === $company->id)
                                    {{ $item->id }}
                                    {{ $item->detail }}
                                    {{ $item->duration }}
                                @endif
            ...
            <div class="flex">
                <div class="mx-6 flex-1">
                    <form action="{{ route('Companies.index', $company->id) }}" method="GET">
                        <button type="submit"
