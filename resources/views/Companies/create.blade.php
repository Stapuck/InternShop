    ...
    <div class="flex justify-center items-center h-screen">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Création d'une entreprise</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST" action="{{ route('Companies.store') }}">
                    @csrf
