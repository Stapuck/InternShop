    ...
    <div class="flex justify-center items-center h-screen">
        <div class="flex-1 max-w-lg p-8 mx-2 bg-[#ffff] rounded-sm shadow-md">
            ...
            <section class="pt-2 pb-4">
                <h1 class="text-xl font-extrabold uppercase flex justify-center">Promotions</h1>
            </section>

            <section>
                <form class="flex flex-col" method="POST" action="{{ route('Promotions.store') }}">
                    @csrf

                    <!-- Name -->
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase" for="steps">Nom de
                            la promotion</label>
                    ...
                    {{-- <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="establishments_id">Id
                            établissement</label>
                        <input type="number" min="0" name="establishments_id" autofocus required
                            class="w-full px-3 pb-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-green-[#4A7B59] hover:border-[#347260]" />
                    </div> --}}
                    
                    <div class="pt-2 mb-4 bg-gray-100 rounded-sm">
                        <label class="block mx-3 mb-2 text-xs font-bold text-gray-700 uppercase"
                            for="name">Nom de la promotion</label>
                        <div>
                            <select name="establishments_id" id="establishement"
                                class="w-full px-3 text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]"">
                                <option
                                    class="w-full px-3  text-sm text-gray-700 transition duration-300 bg-gray-100 border-b-2 border-gray-200 rounded-sm focus:outline-none focus:border-[#4A7B59] hover:border-[#347260]"">
                                    Sélectionnez un établissement</option>
                                @foreach ($etablishment as $item)
                    ...
                    <button type="submit"
                        class="w-full p-4 mb-2 mt-4 text-sm font-bold text-white uppercase transition duration-300 bg-[#4A7B59] rounded-sm shadow-sm hover:bg-[#649673] hover:shadow-md">
                        Créer
